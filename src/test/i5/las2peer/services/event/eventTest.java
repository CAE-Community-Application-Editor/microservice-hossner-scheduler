...
/**
 *
 * hossner-scheduler - Test Class
 *
 * This class provides a basic testing framework for the microservice hossner-scheduler. It was
...
public class eventTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(event.class.getCanonicalName(),"0.1");

  private static final String mainPath = "scheduler";
  ...
  public void testgetEvent() {
    ...
    try {
      ...
      System.out.println("Result of 'testgetEvent': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
